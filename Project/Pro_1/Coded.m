function [BER_soft,BER_hard,trellis] = Coded(N,maxNumErrs,maxNum,EbN0)
...
for i = 1:length(EbN0) % use parfor ('help parfor') to parallelize  
  ...
  while((totErr_soft < maxNumErrs) && (num < maxNum)) 
  % ===================================================================== %
...
%   C_encoded= gen_4(bits); % 4th encoder
  ...
  %% [MOD] Symbol Mapper - Mode is based on the flags set in the beginning.
    ...
    [symb_coded,const,trellis] = symbol_mapper1(bits,modulation);
