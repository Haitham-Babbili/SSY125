...
t.outputs = [0,3;2,1;3,0;1,2;3,0;1,2;0,3;2,1;0,3;2,1;3,0;1,2;3,0;1,2;0,3;2,1];
spect = distspec(t,25);
...
legend('coded transmision with encoder 2','theoritical BER upper bound');

xlabel('EbN0');
ylabel('BER');
title('Part2 Q2 encoder 2');
% ======================================================================= %
% End
% ====================================================================== %